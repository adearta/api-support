                    ...
                    switch ($request->status) {
                        case 1:
                            if ($schParticipantValidation[0]->status > 3) {
                                ...
                                $this->updateStatusParticipant($request->webinar_id, $request->school_id, $request->status);
                            ...
                            if ($schParticipantValidation[0]->status == 1) {
                                ...
                                if ($interval < 4) {
                                    ...
                                    if ($interval == 1) {
                                        ...
                                        $this->updateStatusAndScheduleParticipant($request->webinar_id, $request->school_id, $request->status, $now);
                                        ...
                                        $this->updateStatusAndScheduleParticipant($request->webinar_id, $request->school_id, $request->status, $date);
                                        $message = "Invitation successfully accepted, please input students maximum " . $date;
                                        $code = 200;
                                    }
                                } else {
                                    $this->updateStatusAndScheduleParticipant($request->webinar_id, $request->school_id, $request->status, $date_maximum);
